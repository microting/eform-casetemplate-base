...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.eFormCaseTemplateBase/Microting.eFormCaseTemplateBase.csproj package Microting.eForm
	dotnet add Microting.eFormCaseTemplateBase/Microting.eFormCaseTemplateBase.csproj package Microting.eFormApi.BasePn
